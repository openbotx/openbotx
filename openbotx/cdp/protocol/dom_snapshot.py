...
class DOMNode:
    ...
    event_listeners: list[dom_debugger.EventListener] | None = None
...
def get_snapshot(
    ...
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[list[DOMNode], list[LayoutTreeNode], list[ComputedStyle]],
]:
    """
...
def capture_snapshot(
    ...
    T_JSON_DICT, T_JSON_DICT, tuple[list[DocumentSnapshot], list[str]]
]:
    """
    Returns a document snapshot, including the full DOM tree of the root node (including iframes,
    template contents, and imported documents) in a flattened array, as well as layout and
