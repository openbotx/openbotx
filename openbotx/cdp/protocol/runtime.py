...
class RemoteObject:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RemoteObject:
        return cls(
            ...
            deep_serialized_value=DeepSerializedValue.from_json(json["deepSerializedValue"])
...
def await_promise(
    ...
    T_JSON_DICT, T_JSON_DICT, tuple[RemoteObject, ExceptionDetails | None]
]:
    """
...
def compile_script(
    ...
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[ScriptId | None, ExceptionDetails | None],
]:
    """
    Compiles expression.
...
def get_heap_usage() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, tuple[float, float, float, float]
]:
    """
...
def query_objects(
    prototype_object_id: RemoteObjectId, object_group: str | None = None
