...
def continue_to_location(
    location: Location, target_call_frames: str | None = None
...
def evaluate_on_call_frame(
    ...
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[runtime.RemoteObject, runtime.ExceptionDetails | None],
]:
    """
...
def disassemble_wasm_module(
    ...
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[str | None, int, list[int], WasmDisassemblyChunk],
]:
    """
...
def restart_frame(
    call_frame_id: CallFrameId, mode: str | None = None
) -> typing.Generator[
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[
...
def set_blackbox_patterns(
    patterns: list[str], skip_anonymous: bool | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_blackboxed_ranges(
    script_id: runtime.ScriptId, positions: list[ScriptPosition]
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_breakpoint(
    location: Location, condition: str | None = None
...
def set_breakpoint_on_function_call(
    object_id: runtime.RemoteObjectId, condition: str | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, BreakpointId]:
    """
