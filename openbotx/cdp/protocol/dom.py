...
def copy_to(
    node_id: NodeId, target_node_id: NodeId, insert_before_node_id: NodeId | None = None
...
def get_content_quads(
    ...
    backend_node_id: BackendNodeId | None = None,
    object_id: runtime.RemoteObjectId | None = None,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[Quad]]:
    """
...
def get_document(
    depth: int | None = None, pierce: bool | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, Node]:
    """
...
def get_flattened_document(
    depth: int | None = None, pierce: bool | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[Node]]:
    """
    Returns the root DOM node (and optionally the subtree) to the caller.
...
def get_nodes_for_subtree_by_style(
    ...
    pierce: bool | None = None,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[NodeId]]:
    """
...
def get_node_for_location(
    ...
    T_JSON_DICT, T_JSON_DICT, tuple[BackendNodeId, page.FrameId, NodeId | None]
]:
    """
...
def perform_search(
    query: str, include_user_agent_shadow_dom: bool | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, tuple[str, int]]:
    """
...
def request_child_nodes(
    node_id: NodeId, depth: int | None = None, pierce: bool | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_attributes_as_text(
    node_id: NodeId, text: str, name: str | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def get_node_stack_traces(
    node_id: NodeId,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, runtime.StackTrace | None]:
    """
...
def get_detached_dom_nodes() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, list[DetachedElementInfo]
]:
    """
...
def get_frame_owner(
    ...
    T_JSON_DICT, T_JSON_DICT, tuple[BackendNodeId, NodeId | None]
]:
    """
...
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, NodeId | None]:
    """
...
def get_anchor_element(
    node_id: NodeId, anchor_specifier: str | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, NodeId]:
    """
...
class CharacterDataModified:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CharacterDataModified:
        return cls(
            node_id=NodeId.from_json(json["nodeId"]), character_data=str(json["characterData"])
        )
...
class ChildNodeCountUpdated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ChildNodeCountUpdated:
        return cls(
            node_id=NodeId.from_json(json["nodeId"]), child_node_count=int(json["childNodeCount"])
        )
...
class ScrollableFlagUpdated:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScrollableFlagUpdated:
        return cls(
            node_id=NodeId.from_json(json["nodeId"]), is_scrollable=bool(json["isScrollable"])
        )
...
class ShadowRootPopped:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ShadowRootPopped:
        return cls(
            host_id=NodeId.from_json(json["hostId"]), root_id=NodeId.from_json(json["rootId"])
        )
