...
class InspectorIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InspectorIssueDetails:
        return cls(
            ...
            permission_element_issue_details=PermissionElementIssueDetails.from_json(
                json["permissionElementIssueDetails"]
            )
            if json.get("permissionElementIssueDetails", None) is not None
            else None,
        )
...
def check_forms_issues() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, list[GenericIssueDetails]
]:
    """
