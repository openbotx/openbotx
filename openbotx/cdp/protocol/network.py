...
class Request:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Request:
        return cls(
            ...
            if json.get("isAdRelated", None) is not None
            else None,
        )
...
class ServiceWorkerRouterInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ServiceWorkerRouterInfo:
        return cls(
            ...
            actual_source_type=ServiceWorkerRouterSource.from_json(json["actualSourceType"])
...
class NetworkConditions:
    ...
    def from_json(cls, json: T_JSON_DICT) -> NetworkConditions:
        return cls(
            ...
            connection_type=ConnectionType.from_json(json["connectionType"])
            if json.get("connectionType", None) is not None
            else None,
            packet_loss=float(json["packetLoss"])
...
class DirectUDPSocketOptions:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DirectUDPSocketOptions:
        return cls(
            ...
            multicast_loopback=bool(json["multicastLoopback"])
            if json.get("multicastLoopback", None) is not None
            else None,
            multicast_time_to_live=int(json["multicastTimeToLive"])
            if json.get("multicastTimeToLive", None) is not None
            else None,
            multicast_allow_address_sharing=bool(json["multicastAllowAddressSharing"])
...
class ClientSecurityState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ClientSecurityState:
        return cls(
            ...
            local_network_access_request_policy=LocalNetworkAccessRequestPolicy.from_json(
...
class DeviceBoundSession:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DeviceBoundSession:
        return cls(
            ...
            cookie_cravings=[
                DeviceBoundSessionCookieCraving.from_json(i) for i in json["cookieCravings"]
            ],
...
class DeviceBoundSessionEventId(str):
    ...
    def __repr__(self):
        return f"DeviceBoundSessionEventId({super().__repr__()})"
...
class CreationEventDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CreationEventDetails:
        return cls(
            ...
            new_session=DeviceBoundSession.from_json(json["newSession"])
...
def emulate_network_conditions_by_rule(
    offline: bool, matched_network_conditions: list[NetworkConditions]
...
def get_request_post_data(
    ...
    json = yield cmd_dict
    return (str(json["postData"]), bool(json["base64Encoded"]))
...
def load_network_resource(
    url: str, options: LoadNetworkResourceOptions, frame_id: page.FrameId | None = None
...
class RequestWillBeSent:
    ...
    render_blocking_behavior: RenderBlockingBehavior | None
...
class DirectUDPSocketJoinedMulticastGroup:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> DirectUDPSocketJoinedMulticastGroup:
        return cls(
            identifier=RequestId.from_json(json["identifier"]), ip_address=str(json["IPAddress"])
        )
...
class RequestWillBeSentExtraInfo:
    ...
    **EXPERIMENTAL**
    ...
    device_bound_session_usages: list[DeviceBoundSessionWithUsage] | None
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSentExtraInfo:
        return cls(
            ...
            device_bound_session_usages=[
                DeviceBoundSessionWithUsage.from_json(i) for i in json["deviceBoundSessionUsages"]
            ]
            ...
            site_has_cookie_in_other_partition=bool(json["siteHasCookieInOtherPartition"])
            if json.get("siteHasCookieInOtherPartition", None) is not None
            else None,
            applied_network_conditions_id=str(json["appliedNetworkConditionsId"])
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ResponseReceivedExtraInfo:
        return cls(
            ...
            cookie_partition_key=CookiePartitionKey.from_json(json["cookiePartitionKey"])
...
class DeviceBoundSessionsAdded:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> DeviceBoundSessionsAdded:
        return cls(sessions=[DeviceBoundSession.from_json(i) for i in json["sessions"]])
...
class DeviceBoundSessionEventOccurred:
    ...
    **EXPERIMENTAL**
    ...
    creation_event_details: CreationEventDetails | None
    refresh_event_details: RefreshEventDetails | None
    termination_event_details: TerminationEventDetails | None
    challenge_event_details: ChallengeEventDetails | None
    ...
    def from_json(cls, json: T_JSON_DICT) -> DeviceBoundSessionEventOccurred:
        return cls(
            ...
            creation_event_details=CreationEventDetails.from_json(json["creationEventDetails"])
            if json.get("creationEventDetails", None) is not None
            else None,
            refresh_event_details=RefreshEventDetails.from_json(json["refreshEventDetails"])
            if json.get("refreshEventDetails", None) is not None
            else None,
            termination_event_details=TerminationEventDetails.from_json(
                json["terminationEventDetails"]
            )
            if json.get("terminationEventDetails", None) is not None
            else None,
            challenge_event_details=ChallengeEventDetails.from_json(json["challengeEventDetails"])
