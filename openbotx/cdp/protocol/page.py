...
class Frame:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Frame:
        return cls(
            ...
            security_origin_details=SecurityOriginDetails.from_json(json["securityOriginDetails"])
...
class WebAppManifest:
    ...
    def from_json(cls, json: T_JSON_DICT) -> WebAppManifest:
        return cls(
            ...
            protocol_handlers=[ProtocolHandler.from_json(i) for i in json["protocolHandlers"]]
            ...
            scope_extensions=[ScopeExtension.from_json(i) for i in json["scopeExtensions"]]
...
class BackForwardCacheNotRestoredExplanation:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BackForwardCacheNotRestoredExplanation:
        return cls(
            ...
            details=[BackForwardCacheBlockingDetails.from_json(i) for i in json["details"]]
...
def get_installability_errors() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, list[InstallabilityError]
]:
    """
...
def get_app_id() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, tuple[str | None, str | None]
]:
    """
...
def get_ad_script_ancestry(
    frame_id: FrameId,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, AdScriptAncestry | None]:
    """
...
def get_navigation_history() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, tuple[int, list[NavigationEntry]]
]:
    """
...
def navigate(
    ...
    T_JSON_DICT,
    tuple[
        FrameId, network.LoaderId | None, str | None, bool | None
    ],
]:
    """
...
def print_to_pdf(
    ...
    T_JSON_DICT, T_JSON_DICT, tuple[str, io.StreamHandle | None]
]:
    """
    Print page as PDF.
...
class FrameNavigated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FrameNavigated:
        return cls(
            frame=Frame.from_json(json["frame"]), type_=NavigationType.from_json(json["type"])
        )
