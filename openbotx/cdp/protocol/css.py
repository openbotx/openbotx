...
class InheritedAnimatedStyleEntry:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InheritedAnimatedStyleEntry:
        return cls(
            animation_styles=[CSSAnimationStyle.from_json(i) for i in json["animationStyles"]]
...
class CSSRule:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSRule:
        return cls(
            ...
            origin_tree_scope_node_id=dom.BackendNodeId.from_json(json["originTreeScopeNodeId"])
            ...
            starting_styles=[CSSStartingStyle.from_json(i) for i in json["startingStyles"]]
...
class CSSProperty:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSProperty:
        return cls(
            ...
            longhand_properties=[CSSProperty.from_json(i) for i in json["longhandProperties"]]
...
def create_style_sheet(
    frame_id: page.FrameId, force: bool | None = None
...
def get_computed_style_for_node(
    ...
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[list[CSSComputedStyleProperty], ComputedStyleExtraFields],
]:
    """
...
def get_inline_styles_for_node(
    ...
    T_JSON_DICT, T_JSON_DICT, tuple[CSSStyle | None, CSSStyle | None]
]:
    """
...
def take_computed_style_updates() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, list[dom.NodeId]
]:
    """
...
def stop_rule_usage_tracking() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, list[RuleUsage]
]:
    """
...
def take_coverage_delta() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, tuple[list[RuleUsage], float]
]:
    """
