...
def request_cache_names(
    ...
    storage_bucket: storage.StorageBucket | None = None,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[Cache]]:
    """
...
def request_cached_response(
    cache_id: CacheId, request_url: str, request_headers: list[Header]
...
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, tuple[list[DataEntry], float]]:
    """
