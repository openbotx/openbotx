...
def attach_to_target(
    target_id: TargetID, flatten: bool | None = None
...
def get_browser_contexts() -> typing.Generator[
    T_JSON_DICT,
    T_JSON_DICT,
    tuple[list[browser.BrowserContextID], browser.BrowserContextID | None],
]:
    """
...
def detach_from_target(
    session_id: SessionID | None = None, target_id: TargetID | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_discover_targets(
    discover: bool, filter_: TargetFilter | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def open_dev_tools(
    target_id: TargetID, panel_id: str | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, TargetID]:
    """
