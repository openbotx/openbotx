...
def get_os_app_state(
    manifest_id: str,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, tuple[int, list[FileHandler]]]:
    """
...
def install(
    manifest_id: str, install_url_or_bundle_url: str | None = None
...
def launch(
    manifest_id: str, url: str | None = None
...
def launch_files_in_app(
    manifest_id: str, files: list[str]
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[target.TargetID]]:
    """
