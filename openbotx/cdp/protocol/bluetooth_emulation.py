...
class ScanRecord:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScanRecord:
        return cls(
            ...
            manufacturer_data=[ManufacturerData.from_json(i) for i in json["manufacturerData"]]
...
def simulate_descriptor_operation_response(
    descriptor_id: str, type_: DescriptorOperationType, code: int, data: str | None = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
